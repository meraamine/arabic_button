...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(date, time) => "التاريخ : ${date} الوقت : ${time}";

  static String m1(name) => " مرحبا ${name}";

  static String m2(firstName, lastName) =>
      "اسمي  ${lastName}, ${firstName} ${lastName}";

  static String m3(howMany) =>
      "${Intl.plural(howMany, one: 'لديك', other: ' ${howMany} رسائل')}";

  static String m4(total) => "الاجمالي :   ${total}";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        "pageHomeListTitle":
            MessageLookupByLibrary.simpleMessage("بعض الجمل المترجمة :"),
